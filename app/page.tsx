  ...
  return (
    <main className={styles.main}>
      ...
      <div className={styles.banner}>
        <img
          src="https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?w=1800&q=80"
          alt=""
        ...
        <div className={styles.container}>
          <div className={styles.bannerBody}>
            <p className={styles.eyebrow} style={{ color: "#c9a84c" }}>Our Reach</p>
            <h2 className={styles.bannerH2}>Connecting mines to markets<br />across three continents</h2>
